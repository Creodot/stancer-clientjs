    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/Creodot/stancer-clientjs/tree/main/docs/',
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Creodot/stancer-clientjs',
          label: 'GitHub',
          position: 'right',
        },
      ],
